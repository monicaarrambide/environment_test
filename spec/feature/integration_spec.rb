...
RSpec.describe 'Creating a book', type: :feature do
  ...
  scenario 'valid inputs for title' do
    ...
    select '2021', :from => 'item_date_1i'
    select 'May', :from => 'item_date_2i'
    select '25', :from => 'item_date_3i'
...
RSpec.describe 'Updating a book', type: :feature do
  scenario 'valid inputs' do
    bookThief = Item.create!(title: 'book thief', author: 'mark zusak', price: 5.50, date: '2022-02-02')
